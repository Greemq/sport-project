<template>
    <div class="mt-3">
        <div style="position: relative" class="relative items-center block">
            ...
            <img v-else class="h-auto rounded-lg" src="../../assets/img/image_thumb.jpg" alt="image description"
                 :class="{'text-red-800 border border-red-300 dark:text-red-400 dark:border-red-400':error}">
