                        ...
                        <td class="px-6 py-4 w-10">
                            <div class="flex items-center justify-end">
                                <svg class="w-6 h-6 text-gray-800 dark:text-white cursor-pointer h-full"
                                     aria-hidden="true"
                                     @click="$router.push({name:'files_item',params:{id:item.id}})"
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            this.page += 1;
            requests.getFilesList({page: this.page}).then(res => {
        ...
        getType(type) {
            ...
            switch (type) {
                case 1:
                    res = 'Нормативные документы';
                    break;
                case 2:
                    res = 'Аналитические отчеты и доклады о проделынной работе';
                    break;
                default:
                    res = '';
                    break;
