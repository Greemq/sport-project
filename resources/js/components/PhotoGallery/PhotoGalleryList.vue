    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div class=" flex justify-end">
                <button type="button" @click="$router.push({name:'photo_gallery_item_create'})"
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="flex items-start">
                                <img class="w-18 h-36 rounded" :src="item.path">
                            </div>
                        </th>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 w-10">
                            <div class="flex items-center justify-end">
                                <svg class="w-6 h-6 text-gray-800 dark:text-white cursor-pointer h-full"
                                     aria-hidden="true"
                                     @click="$router.push({name:'photo_gallery_item',params:{id:item.id}})"
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            this.page += 1;
            requests.getGalleryList({page: this.page}).then(res => {
