...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::prefix('photo_gallery')->group(function () {
        ...
        Route::get('/{id}', [\App\Http\Controllers\PhotoGalleryController::class, 'item']);
        Route::post('', [\App\Http\Controllers\PhotoGalleryController::class, 'store']);
        Route::post('/{id}/update', [\App\Http\Controllers\PhotoGalleryController::class, 'update']);
    });

    Route::prefix('video_gallery')->group(function () {
        Route::get('', [\App\Http\Controllers\VideoController::class, 'index']);
        Route::get('/{id}', [\App\Http\Controllers\VideoController::class, 'item']);
        Route::post('', [\App\Http\Controllers\VideoController::class, 'store']);
        Route::post('/{id}/update', [\App\Http\Controllers\VideoController::class, 'update']);
